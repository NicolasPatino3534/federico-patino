...
export default function SearchBox({ defaultOperation = 'venta', variant = 'hero' }: Props) {
  ...
  return (
    <div className={`w-full max-w-4xl ${isHero ? 'bg-white rounded-xl shadow-[0_30px_80px_rgba(0,0,0,0.35)]' : 'bg-slate-50 rounded-xl border border-slate-200'} p-2`}>
      {/* Tabs */}
          ...
          >
            ...
            {tab === 'venta' ? (
              <>
                ...
                <option value="400000">USD 400.000</option>
              </>
            ) : (
              <>
                <option value="200000">$ 200.000 / mes</option>
                <option value="400000">$ 400.000 / mes</option>
                <option value="700000">$ 700.000 / mes</option>
                <option value="1000000">$ 1.000.000 / mes</option>
              </>
            )}
          </select>
        </div>
